...
public class PatientServiceDb : IPatientService
{
    ...
    {
        return db.Users.FirstOrDefault(u => u.Email == email && u.UserId != userId) == null;
    }
    ...
    public User AddUser(User user)
    {
        ...
        var exists = GetUserByEmail(user.Email);
        if (exists != null)
        {
            return null;
        }
    ...
    public User UpdateUser(User updated)
    {
        ...
        var user = GetUserByEmail(updated.Email);
        if (user == null)
        {
            return null;
        }
 ...
 public User GetCarerByUserId(int id)
    ...
    public bool DeleteCarer(int id)
    {
        var c = GetCarerById(id);
        if (c == null)
        {
            return false;
        }
    ...
    {
        //check day being passed does not exist
        var exists = GetAppointmentByDateTime(md.DateTime);
        if (exists != null)
        {
            return null; // day cannot be added as they already exist
        }
        // update the information for the patient and save
